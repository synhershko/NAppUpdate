    ...
    public class FeedBuilderSettingsProvider : SettingsProvider
    {
        ...
        public void SaveAs(string filename)
        {
            try
            {
                ...
                {
                    throw new Exception("settings file did not exist: " + source);
                }
        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection propvals)
        {
            ...
            try
            {
                ...
                string path = Path.Combine(GetAppSettingsPath(), GetAppSettingsFilename());
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (MachineNode == null)
                    {
                        ...
                        {
                            selectSingleNode.AppendChild(MachineNode);
                        }
                        else
                        {
                    ...
                    var currentState = SettingsXML.InnerXml;
                }
            }
        }
